...
int game_rr(int score)
{
    ...
    while(1)

        {
            ...
            obstacle(bx-20,  by1-1800);
            obstacle(bx+80 ,  by1-1900);
            obstacle(bx-100, by1-2000);
            obstacle(bx+50, by1-2100);
            obstacle(bx+100, by1-2200);
            obstacle(bx+80 , by1-2350);
            obstacle(bx+190 , by1-2500);
            ...
            by1= by1 +8;
                ...
                if(
                   ...
                   || (check(cx +r, cy+210 , bx+560-20,by1-1800,bx+620-20,by1+40-1800)==1)||
                       ...
                       (check(cx+r , cy+210, bx+80,    by1-1900,   bx+70+80, by1+50-1900)==1)
                    || (check(cx+r,  cy+210, bx+180+80,by1+30-1900,bx+220+80,by1+70-1900)==1)
                    || (check(cx +r, cy+210, bx+300+80,by1-1900,   bx+350+80,by1+50-1900)==1)
                    || (check(cx +r, cy+210, bx+410+80,by1-1900,   bx+500+80,by1+30-1900)==1)
                    || (check(cx +r, cy+210, bx+560+80,by1-1900,   bx+620+80,by1+40-1900)==1) ||
                   ...
                   || (check( cx+r, cy+210 , bx+410-100,by1-2000,   bx+500-100,by1+30-2000)==1)
                    || (check(cx+r,  cy+210 , bx+560-100,by1-2000,  bx+620-100,by1+40-2000)==1)||
                            ...
                            (check(cx+r ,cy+210, bx+50,    by1-2100,bx+70+50,by1+50-2100) ==1)
                       || (check(cx+r , cy+210 , bx+180+50,by1+30-2100,bx+220+50,by1+70-2100)==1)
                        || (check(cx +r, cy+210, bx+300+50,by1-2100,bx+350+50,by1+50-2100)==1)
                       || (check(cx +r, cy+210,  bx+410+50,by1-2100,bx+500+50,by1+30-2100)==1)
                        || (check(cx+r,  cy+210 ,bx+560+50,by1-2100,  bx+620+50,by1+40-2100)==1)||

                        (check(cx+r,cy+210,bx+100,by1-2200,bx+70+100,by1+50-2200) ==1)
                   || (check(cx+r , cy+210 , bx+180+100,by1+30-2200,bx+220+100,by1+70-2200)==1)
                    || (check(cx +r, cy+210, bx+300+100,by1-2200,bx+350+100,by1+50-2200)==1)
                   || (check(cx +r, cy+210 , bx+410+100,by1-2200,bx+500+100,by1+30-2200)==1)
                    || (check(cx+r,  cy+210 , bx+560+100,by1-2200,  bx+620+100,by1+40-2200)==1)||
                   ...
                   || (check(cx +r, cy+210, bx+410+80,by1-2350,bx+500+80,by1+30-2350)==1)
                    || (check(cx+r,  cy+210, bx+560+80,by1-2350,  bx+620+80,by1+40-2350)==1)||
                        ...
                        (check(cx+r,cy+210,bx+190 ,by1-2500,bx+70+190 ,by1+50-2500) ==1)
                   || (check(cx+r , cy+210 , bx+180+190 ,by1+30-2500,bx+220+190 ,by1+70-2500)==1)
                    || (check(cx +r, cy+210 , bx+300+190 ,by1-2500,bx+350 +190,by1+50-2500)==1)
                   || (check(cx +r, cy+210, bx+410+190,by1-2500,bx+500 +190,by1+30-2500)==1)
                    || (check(cx+r,  cy+210, bx+560+190,by1-2500,  bx+620+190,by1+40-2500)==1)||
            ...
            obstacle(bx1 - 2100 -p, by2 - 3100+p);
               ...
               by2+=7.95;
                ...
                if(by3-6450>480)
                {
                  bx=0,by=50,ch,by1=50,bx1=0,by2=50,bx2=1000,by3=50;
                }
            page = 1-page;
        }
}
