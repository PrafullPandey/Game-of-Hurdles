...
int shoot()
{
    ...
    while(1)
    {
        ...
        settextstyle(DEFAULT_FONT,HORIZ_DIR,3);
        outtextxy(40,450,"KILL THE WHITE WALKER");
        ...
        A:
            ...
            while(temp1->next!=NULL)
            {
                for(j=0;j<7;j++)
                {
                    ...
                    {
                                setcolor(YELLOW);
                                outtextxy(temp1->next->bx1-10,temp1->next->mid,"+ 25 ");
                                score=score+25;
                                //arrow
            ...
            for(j=0;j<7;j++)
            {
                if(cx[j]<20&&cx[j]>0)
                {
                    ...
                    if(y1<ly2[j]+7&&y1>cy[j]-10)
                    {
                        //return score;
                        gameover_shoot();
                        return score;
                    }
                    if(y>cy[j]-10&&y<ly2[j]+7)
                    {
                           // return score ;
                        gameover_shoot();
                        return score;
                    }
                    if(y1<cy[j]-10&&y>ly2[j]+7)
                    {
                        //return score;
                        gameover_shoot();
                        return score;
